...
export const metadata: Metadata = {
  ...
  description:
    "21 anos integrando câmeras, inteligência artificial e detecção térmica . Soluções sob medida para varejo, portos, energia, agronegócio e healthcare.",
  ...
  twitter: {
    ...
    title: "ESI Exata | Segurança, CFTV e IA para Varejo, Portos e Indústria",
    description:
      "21 anos integrando câmeras, inteligência artificial e detecção térmica .",
    images: ["/og-image.svg"],
  },
  robots: {
    index: true,
...
const jsonLd = {
  ...
  description:
    "21 anos integrando câmeras, inteligência artificial e detecção térmica para eliminar perdas em varejo, portos, energia, agronegócio e healthcare.",
  address: {
    "@type": "PostalAddress",
